...
// [ApiController]
// [Route("/[controller]")]
// public class DemoUploadFileController(IRepository repository, ILogger<DemoUploadFileController> logger) : ControllerBase
// {
//     private readonly IRepository _repository = repository;
//     private readonly ILogger<DemoUploadFileController> _logger = logger;
...
//             (await _repository.GetService<IResourceManagerService>())
//                 .Resource<IBehavioralEntity>("_todo_", false));
//         return Ok("success");
//     }
...
//     {
//         var file = (await _repository.GetService<IResourceManagerService>())
//             .Resource<IBehavioralEntity>("_todo_");
